...
import (
	...
	"github.com/example/canary-operator/controllers"
...
func main() {
	...
	flag.StringVar(&prometheusAddr, "prometheus-address", "http://prometheus-server.monitoring:9090", "The address of the Prometheus server.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "canary-operator-leader-election",
	})
	if err != nil {
